...
#     print("Parameters in json object: ", parameters_json_object)
    with open("parameters_changeable.json","w") as parameters_json:
...
def printParameters():
    parameters_print = json.load(open("parameters_changeable.json"))
    print("Parameters in JSON: ", json.dumps(parameters_print))

#load the parameters from the parameters.json file
def loadParameters():
    return (json.load(open("/parameters_changeable.json")), json.load(open("/parameters_unchangeable.json")))
